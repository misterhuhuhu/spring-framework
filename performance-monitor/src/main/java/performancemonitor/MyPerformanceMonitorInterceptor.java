...
public class MyPerformanceMonitorInterceptor extends AbstractMonitoringInterceptor {
    ...
    protected Object invokeUnderTrace(MethodInvocation invocation, Log log) throws Throwable {
        ...
        System.out.println("Method "+name+" execution started at:"+new Date());
        try {
            ...
            System.out.println("Method "+name+" execution ended at:"+new Date());
            
            if (time > 10){
                System.out.println("Method execution longer than 10 ms!");
            }
